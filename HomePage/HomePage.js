document.addEventListener("DOMContentLoaded", () => {
    ...
    function HomePage() {
        ...
        //generating random probability of loading the authors info
        function getRandomElements(arr) {
            //safety check if there are only 2 authors in the author table , then display the same author twicw
        ...
        fetch("http://localhost/ONLINEBOOKSTORE/GetAuthors.php")
            ...
            .then(data => {
                //the fetch parse JSON into objects  
